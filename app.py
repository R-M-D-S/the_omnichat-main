            ...
            st.session_state.messages.append(
                {
                    ...
                    "content": [{
                        "type": "text",
                        "text": f"Answer the following question: {prompt}. Instruction: Ensure your response is in KaTex format with expressions wrapped in the following: $" or f"Answer the following question: {audio_prompt}. Instruction: Ensure your response is in KaTex format with expressions wrapped in the following: $",
                    }]
                }
            )
